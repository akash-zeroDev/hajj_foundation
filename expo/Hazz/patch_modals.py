...
# 1. Suspend Modal
old_suspend = """          <div className="relative bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm text-center animate-modal-pop">
...
new_suspend = """          <div className="relative bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-200 p-6 w-full max-w-[420px] animate-modal-pop">
...
# 2. Remove Modal
old_remove = """          <div className="relative bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm text-center animate-modal-pop">
            <div className="mx-auto flex items-center justify-center h-14 w-14 rounded-full mb-4 bg-red-100">
              <AlertTriangle className="h-7 w-7 text-red-600" />
            </div>
...
new_remove = """          <div className="relative bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-200 p-6 w-full max-w-[420px] animate-modal-pop">
            <div className="flex items-start gap-4">
              <div className="flex items-center justify-center h-10 w-10 shrink-0 rounded-full bg-red-50 border border-red-100 text-red-600">
                <AlertTriangle className="h-5 w-5" />
              </div>
...
# 3. Revoke Modal
old_revoke = """          <div className="relative bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm text-center animate-modal-pop">
...
new_revoke = """          <div className="relative bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-200 p-6 w-full max-w-[420px] animate-modal-pop">
            <div className="flex items-start gap-4">
